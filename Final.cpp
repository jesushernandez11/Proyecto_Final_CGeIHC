...
int main()
{
	...
	// -------------------------
	Shader staticShader("Shaders/shader_Lights.vs", "Shaders/shader_Lights_mod.fs");//modelos estáticos
	Shader skyboxShader("Shaders/skybox.vs", "Shaders/skybox.fs");
	Shader animShader("Shaders/anim.vs", "Shaders/anim.fs");//animaciones
	...
	// load models
	// -----------
	Model brujas("resources/objects/Brujas/brujas.obj");
	Model cajaText("resources/objects/CajaText/cajaText.obj");
	...
	Model pez1("resources/objects/Pez1/pez1.obj");
	...
	/*ModelAnim pez1("resources/objects/Pez1/pez1.dae");
	...
	*/
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		/*
		model = glm::translate(glm::mat4(1.0f), glm::vec3(120.0f, 5.0f, 0.0f));
		...
		model = glm::translate(glm::mat4(1.0f), glm::vec3(-160.0f, 0.0f, 0.0f));
		model = glm::scale(model, glm::vec3(3.5f));
		staticShader.setMat4("model", model);
		brujas.Draw(staticShader);

		model = glm::translate(glm::mat4(1.0f), glm::vec3(0.0f, 0.0f, 160.0f));
		staticShader.setMat4("model", model);
		cajaText.Draw(staticShader);

		model = glm::translate(glm::mat4(1.0f), glm::vec3(90.0f, 0.0f, 0.0f));
		...
		model = glm::scale(model, glm::vec3(1.2f));
		staticShader.setMat4("model", model);
		pez1.Draw(staticShader); //modelo de pez creado
