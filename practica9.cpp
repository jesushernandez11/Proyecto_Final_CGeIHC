...
int main()
{
	...
	while (!mainWindow.getShouldClose())
	{
		...
		//if (avanzaHeli) {
		//	if (movHeli > -100.0) {
		//		movHeli -= 0.003*movHeliOffset* deltaTime;
		//		movHeliOffset += 5.0f;
		//	}
		//	else {
		...
		printf("%f\n", glm::radians(sin(movHeliOffset*0.03)));
		model = glm::mat4(1.0);
		model = glm::translate(model, glm::vec3(0.0f , 5.0f+glm::radians(100*sin(movHeliOffset*0.008)), 6.0));
